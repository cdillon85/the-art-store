...
const seedProducts = () => db.Promise.map([
	...
	{title: 'Harran II', artist_id: 1, year: 1967, url: amazonRoute + 'Harran_II_Frank Stella.jpg', price: 2000, tags: ['Frank Stella', 'Painting', 'Multi-colored', 'Circular' ], description: 'Lyrical and multi-colored painting, based on the semicircular drafting instrument used for measuring and constructing angles.', medium: 'Painting', dimensions: [609.6, 0, 304.8], quantity: 5, artistName: 'Frank Stella'},
	...
	{title: 'Gur I', artist_id: 1, year: 1968, url: amazonRoute + 'Gur_I_Frank_Stella.jpg', price: 2000, tags: ['Frank Stella', 'Painting', 'Multi-colored', 'Circular' ], description: 'A largescale painting with a striking color palette and composition', medium: 'Painting', dimensions: [458.47, 0, 304.8], quantity: 5, artistName: 'Frank Stella'},
	//Agnes Martin
