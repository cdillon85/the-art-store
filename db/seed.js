...
const seedProducts = () => db.Promise.map([
	...
	{title: 'Harran II', artist_id: 1, year: 1967, url: amazonRoute + 'NEW_Harran_II_Frank Stella.jpg', price: 2000, tags: ['Frank Stella', 'Painting', 'Multi-colored', 'Circular' ], description: 'Lyrical and multi-colored painting, based on the semicircular drafting instrument used for measuring and constructing angles.', medium: 'Painting', dimensions: [609.6, 0, 304.8], quantity: 5, artistName: 'Frank Stella'},
